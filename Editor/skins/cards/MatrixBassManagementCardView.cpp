/*
	...
	Signal Matrix's bass-management card: a departure-board posting (see the
	...
	: BassManagementCardView(parent)
{
	...
	postingRow->addWidget(makeReadoutColumn(tr("STATE"), stateCell,
		...
		tr("Whether this bass-management state passes validation")));
...
QWidget* MatrixBassManagementCardView::makeReadoutColumn(
...
void MatrixBassManagementCardView::paintEvent(QPaintEvent* event)
{
