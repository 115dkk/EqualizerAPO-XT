...
{
	setObjectName(QStringLiteral("StudioBassManagementCardView"));
...
QWidget* StudioBassManagementCardView::makeReadoutCell(
...
void StudioBassManagementCardView::paintEvent(QPaintEvent* event)
{
