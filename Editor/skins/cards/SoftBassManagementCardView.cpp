...
SoftBassManagementCardView::SoftBassManagementCardView(
	QWidget* parent)
	: BassManagementCardView(parent)
{
	setObjectName(QStringLiteral("SoftBassManagementCardView"));
...
QLabel* SoftBassManagementCardView::makeFactPill()
{
