...
* **외부 라이브러리** — 저장소에 **커밋하지 않습니다**: [FFTW](https://www.fftw.org/), [libsndfile](https://libsndfile.github.io/libsndfile/), [muParserX](https://github.com/beltoforion/muparserx), [TCLAP](http://tclap.sourceforge.net/), [Google Highway](https://github.com/google/highway), 그리고 MIT 라이선스인 Steinberg VST3 *pluginterfaces*입니다. 빌드 시점에 `deps/` 아래에 배치합니다.
