...
- One-line bass management: `BassManagement:` runs per-speaker-group
  ...
  state (inline or a `*.bmxt.json` profile), with automatic headroom and a
  ...
  `EAPO XT Bass Management` VST3 plugin, exchanging the identical JSON state.
