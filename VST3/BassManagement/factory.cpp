...
class BassManagementFactory final : public IPluginFactory3
{
public:
		...
		void** object) override
	{
		...
		*object = nullptr;
		...
		if (FUnknownPrivate::iidEqual(cid, kComponentCid))
			instance = createBassManagementProcessor();
		else if (FUnknownPrivate::iidEqual(cid, kControllerCid))
			instance = createBassManagementController();
		else
			return kNoInterface;
...
{
	eapoxt::bassmanagement::vst3::moduleInitialized.store(
		true,
