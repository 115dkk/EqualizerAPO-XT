...
6. 베이스 매니지먼트([#246](https://github.com/115dkk/EqualizerAPO-XT/issues/246)): `BassManagement:` 명령, MIT BassManagementCore DSP 라이브러리, 독립 실행형 VST3 플러그인, 4.1 호스트 협상 수정, Editor 카드까지 들어갔고, 전용 전체 편집기와 스킨별 카드 계기를 마무리하는 중입니다.
