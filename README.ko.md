...
4. 프로그래밍 계열 설정 명령(`If:`/`ElseIf:`/`Else:`/`EndIf:`/`Eval:`) 전용 에디터를 만듭니다. 카드 모델이 이 명령들을 인식하게 됐고(분기별 배지 + `If` 블록 들여쓰기, [#178](https://github.com/115dkk/EqualizerAPO-XT/pull/178)), 스킨별 표현과 식 편집기는 진행 중입니다.
